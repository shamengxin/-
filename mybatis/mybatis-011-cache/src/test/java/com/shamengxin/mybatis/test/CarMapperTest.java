...
public class CarMapperTest {
    ...
    public void testSelectById2() throws IOException {
        //这里之后一个SqlSessionFactory对象，二级缓存对应的就是SqlSessionFactory
        ...
        //这行代码结束之后，实际上数据是缓存到一级缓存当中了(sqlSession1)。
        Car car1 = mapper1.selectById2(168L);
        System.out.println(car1);

        //如果这里不关闭SqlSession1对象的化，二级缓存中还是没有数据的。

        //如果执行力这行代码，sqlSession1的一级缓存中的数据会放到二级缓存当中
        sqlSession1.close();

        //这行代码结束之后，实际上数据是缓存到一级缓存当中了((sqlSession1))。
        Car car2 = mapper2.selectById2(168L);
    ...
    public void testSelectById() throws IOException {
        ...
        CarMapper mapper1 = sqlSession1.getMapper(CarMapper.class);
        Car car1 = mapper1.selectById(168L);
        System.out.println(car1);

        CarMapper mapper2 = sqlSession2.getMapper(CarMapper.class);
        Car car2 = mapper2.selectById(168L);
        System.out.println(car2);
    ...
    public void testSelectById(){
        ...
        //这里执行了INSERT或DELETE或UPDATE语句中的任意一个语句。并且和表没有关系
