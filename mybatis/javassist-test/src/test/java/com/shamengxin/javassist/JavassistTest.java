package com.shamengxin.javassist;
...
public class JavassistTest {
    ...
    public void testGenerateAccountDaoImpl() throws Exception{
        ...
        // 制造类
        CtClass ctClass = pool.makeClass("com.shamengxin.bank.dao.Impl.AccountDaoImpl");
        // 制造接口
        CtClass ctInterface = pool.makeInterface("com.shamengxin.bank.dao.AccountDao");
        // 实现接口
        ...
        accountDao.delete();
        accountDao.update("aaaa",10000.0);
    ...
    public void testGenerateFirstClass() throws Exception {
        ...
        Class<?> clazz = Class.forName("com.shamengxin.bank.dao.Impl.AccountDaoImpl");
        //创建对象
